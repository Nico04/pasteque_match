...
class DraggableCard extends StatefulWidget {
  ...
  final Function(double distance, SlideRegion? slideRegion)? onSlideUpdate;
...
class _DraggableCardState extends State<DraggableCard>
  ...
  void initState() {
    ...
    slideBackAnimation = AnimationController(
      ...
      ..addListener(() => setState(() {
            ...
            widget.onSlideUpdate?.call(cardOffset!.distance, slideRegion);
          }))
  ...
  void _onPanUpdate(DragUpdateDetails details) {
    final horizontalDistance = cardOffset!.dx / context.size!.width;
    final verticalDistance = -cardOffset!.dy / context.size!.height;

    setState(() {
      slideRegion = null;
      if (horizontalDistance.abs() > 0.01 || verticalDistance > 0.01) {
        if (horizontalDistance.abs() > verticalDistance) {
          slideRegion = horizontalDistance >= 0 ? SlideRegion.inLikeRegion : SlideRegion.inNopeRegion;
        } else {
