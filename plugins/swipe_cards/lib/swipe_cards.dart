...
class SwipeCards extends StatefulWidget {
  final Widget Function(BuildContext context, int index, double distance, SlideRegion? slideRegion) itemBuilder;
...
class _SwipeCardsState extends State<SwipeCards> {
  ...
  Widget _buildFrontCard() {
    return KeyedSubtree(
      key: _frontCard,
      child: widget.itemBuilder(context, widget.matchEngine._currentItemIndex!, slideDistance, slideRegion),
    );
  }
  ...
  Widget _buildBackCard() {
    return Transform(
      ...
      child: widget.itemBuilder(context, widget.matchEngine._nextItemIndex!, 0, null),
    );
  }

  void _onSlideUpdate(double distance, SlideRegion? region) {
    setState(() {
    ...
    currentMatch?.onSlideUpdate?.call(distance, region);
  }
...
class SwipeItem extends ChangeNotifier {
  ...
  final void Function(double distance, SlideRegion? slideRegion)? onSlideUpdate;
